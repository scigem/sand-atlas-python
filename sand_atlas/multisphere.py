...
import spam.label
from spam.filters import distanceField
...
def binary_to_clump(
    ...
    for i in tqdm(range(numpasses), leave=False, desc="Pass"):
        ...
        dt_diff = distanceField(diff_img)
        ...
        if save_all_passes:
            ...
            if to_save.shape[0] > 0:
                ...
                print(f"No spheres found in pass {i+1}. Skipping saving for this pass.")
